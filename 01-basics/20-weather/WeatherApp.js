...
export default defineComponent({
  ...
  setup() {
    return { getWeatherData, WeatherConditionIcons }
  },
  ...
  template: `
    <div>
      ...
      <ul class="weather-list unstyled-list">
        <li v-for="place in getWeatherData()" :class="[ 'weather-card', { 'weather-card--night': place.current.dt < place.current.sunrise || place.current.dt > place.current.sunset }]">
          ...
          <div class="weather-details">
            <div class="weather-details__item">
              ...
              <div class="weather-details__item-value">{{ (place.current.pressure * 0.75).toFixed() }}</div>
            </div>
            <div class="weather-details__item">
